...
(
"IR_NO" VARCHAR(10),
"NATURE_OF_REMITTANCE"	NUMERIC(3),
...
"REMIT_BANK_INFO4" VARCHAR(35),
"DEPOSIT_BANK"			VARCHAR(11),
"VALUE_DATE"   	NUMERIC(8),
"RECEIVE_DATE"   	NUMERIC(8),
